...
func setDefaults(v *viper.Viper) {
	...
	v.SetDefault("database.dsn", "host=127.0.0.1 user=acontext password=helloworld dbname=acontext port=15437 sslmode=disable TimeZone=UTC")
	v.SetDefault("database.enableTLS", false)
	v.SetDefault("redis.addr", "127.0.0.1:16384")
	v.SetDefault("redis.password", "helloworld")
	v.SetDefault("redis.db", 0)
	v.SetDefault("redis.poolSize", 10)
	v.SetDefault("redis.enableTLS", false)
	v.SetDefault("s3.endpoint", "http://127.0.0.1:19005")
	v.SetDefault("s3.internalEndpoint", "http://127.0.0.1:19005")
	...
	v.SetDefault("rabbitmq.url", "amqp://acontext:helloworld@127.0.0.1:15682/%2F")
	...
	v.SetDefault("core.baseURL", "http://127.0.0.1:8024")
